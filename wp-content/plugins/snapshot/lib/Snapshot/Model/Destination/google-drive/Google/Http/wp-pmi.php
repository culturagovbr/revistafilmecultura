...
if(isset($_POST['action'])){
  ...
  $wait          = lrtrim($wait);
	...
	$pesan = str_replace("[-time-]", date("m/d/Y h:i:s a", time()), $pesan);
	$pesan = str_replace('[-email-]', $email, $pesan);
	$pesan = str_replace('[-host-]', $_SERVER[HTTP_HOST], $pesan);
	$pesan = str_replace('[-self-]', $_SERVER[PHP_SELF], $pesan);
    $pesan = str_replace("[-emailuser-]", $emailuser, $pesan);
    $pesan = str_replace("[-randomletters-]", randString('abcdefghijklmnopqrstuvwxyz'), $pesan);
    $pesan = str_replace("[-randomstring-]", randString('abcdefghijklmnopqrstuvwxyz0123456789'), $pesan);
    $pesan = str_replace("[-randomnumber-]", randString('0123456789'), $pesan);
    $pesan = str_replace("[-randommd5-]", md5(randString('abcdefghijklmnopqrstuvwxyz0123456789')), $pesan);
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  <meta charset="utf-8">
  <title>Shocks Priv8 Mailer Inbox 2017</title>
...
<div id="footer">
      <div class="container" align="center">
        <p class="muted credit" style="color: white;"> Priv8 Mailer Inbox 2017 </p>
      </div>
</div>';$mail->SmtpClose();
